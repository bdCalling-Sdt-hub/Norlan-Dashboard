...
import { useBannersQuery, useCreateBannerMutation, useDeleteBannerMutation } from '../../redux/apiSlices/bannerSlice';
    ...
    return (
        <div>
            ...
            <div className='flex items-center justify-between mb-6'>
                ...
                <label htmlFor="img" className='bg-primary text-white flex items-center justify-center h-10 px-4 rounded-md'>Add Banner</label>
                    ...
                    banners?.map((url, index)=>{
                        return(
                            <div key={index} className='w-full h-[200px] border relative rounded-lg p-2'>
                                ...
                                />
                                <div 
                                    className='w-[35px] h-[35px] bg-primary rounded-full p-[5px] absolute top-[10px] right-[10px] flex items-center justify-center cursor-pointer' 
